    ...
    <div class="iq-card  iq-mb-3">
        <div class="iq-card-header d-flex justify-content-between">
            <div class="iq-header-title">
                ...
                <router-link :to="{name:'list.musics'}" class="btn btn-danger mt-2 btn-sm">
        ...
        <div class="iq-card-body">
            <div class="iq-mb-3 ">
                <div class="card-header ">
                    <i class="fa fa-list"></i> <i>Detalles de la Canción </i>
                    <button class="btn btn-danger mx-2" @click="getChord(-1)"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-dark" @click="getChord(1)"><i class="fa fa-plus"></i></button>
                </div>
                <div class="iq-card-body">
                    <div class="row">
    ...
    methods: {
        ...
        async getChord(semitones) {
            ...
            arrayDetalle.forEach((det) => {
                ...
                let newDetalles = {
                    nombre: det.nombre,
                    contenido: transposedChords.join(' ')
                };
